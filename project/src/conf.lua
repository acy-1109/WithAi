...
local resolutionList = {
    ...
    { width = 2440 / 2, height = 1080 / 2 }, -- note20 for pc
...
function love.conf(t)
    ...
    t.title = "Roguelike Survivor" -- The title of the window
    ...
    "desktop"                                  -- Choose between "desktop" fullscreen or "exclusive" fullscreen mode
